...
COPY scripts/migrations/052_future_alpha_decision_tape.sql scripts/migrations/053_alpha_collection_timing.sql scripts/migrations/054_wallet_fifo_continuation.sql scripts/migrations/055_wallet_fifo_producer_invalidation.sql ./scripts/migrations/
