...
"state": "r42-ingestion-materializer-operational-storage-observation-waiting",
"date": "2026-08-27",
"scope": "R42 bounded one-slot ingestion plus R42 oldest-first wallet-evidence compact materializer; B2 archive remains exact and canonical wallet retirement remains disabled",
...
"verification": "R42 provider/trade tests pass 93/93; populated PostgreSQL16 materializer gates pass 47/47; production oldest-day canary verified count/dual-digest parity for 1477 episodes, 1341 open lots and 700 followability facts in 112917 ms with zero temp growth; storage equilibrium still waits for 26-day catch-up, clean 24h slope and seven future days",
"recovery_point": "memecoin_alpha_20260827T173517Z.dump; 2030534774 bytes; SHA-256 ae4ecfe40cc11318809032df35205a2b0194c456a56ed150eb1b94509ad7a587; server sidecar, PostgreSQL16 archive-list, off-site acknowledgement and independent local generation verified",
...
"storage_sustainability": "Raw chain-payload archive/retirement is operational. Thirty-three wallet-evidence days are independently verified; R42 compact shadow has seven verified receipts, two old retries and 26 days left at one day per 1800 seconds. Exact release artifact plus Walletscaner-only image cleanup returned 7340040192 bytes and left 20495110144 bytes free without touching canonical data, B2, volumes or BuildKit. Canonical retirement and steady-state claims remain disabled until catch-up, dual-read parity, a clean 24h slope and seven future days pass.",
...
"backup_policy": "Daily PostgreSQL16 custom-format dumps use zstd level 1 with no owner/ACL, SHA-256 sidecars and archive-list validation. One unacknowledged generation blocks the next; verified rotation retains a server recovery point and at least two off-host generations. Generation requires newest-size plus 2 GiB headroom and the interval is measured start-to-start. The 2026-08-27 2030534774-byte dump has matching server/off-site/local evidence. Restores remain serial because parallel restore can race migration dependencies.",
...
"rollout_state": "Migrations through 051 are deployed. Ingestion and wallet-evidence materializer run exact R42 sha256:4d9cbf85ada0...; archive writer/verifier/maintenance/monitor remain container-referenced R36, wallet-alpha R34, sampler R29 and Telegram R23. Every container identity/state survived scoped cleanup; selected workers are live=false. Server ledger revision 45 tracks r42-storage-shadow-observation; canonical retirement remains disabled and no score/risk gate was weakened."
},
"stack": {
"language": "typescript",
