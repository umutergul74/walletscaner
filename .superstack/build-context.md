...
"state": "r36-storage-integrity-operational-equilibrium-validation-waiting",
"date": "2026-08-26",
"scope": "R30 ingestion plus R34 wallet-evidence B2 archive/compact shadow and R36 deterministic archive verification plus bounded terminal-gap staging retention; canonical wallet retirement disabled",
...
"verification": "Full PostgreSQL16 clone archive/restore/materializer gate passed; R36 independently reverified both false-positive archive dead letters with exact SHA/restore evidence, reduced archive dead letters to zero and bounded terminal failed-repair staging; storage equilibrium remains waiting for archive catch-up, compact/dual-read parity, a clean 24h slope and seven future days",
"recovery_point": "memecoin_alpha_20260825T150924Z.dump; 2053352363 bytes; SHA-256 ba26a3c89fdb8dc671d92976659ae177a6d8f76be40a45b8b8f774bb54238160; sidecar, PostgreSQL16 archive-list and off-site acknowledgement verified; prior verified off-host generations retained",
...
"storage_sustainability": "Raw chain-payload archive/retirement is operational. Migration 050 wallet-evidence archive and migration 051 compact shadow remain active; R36 makes record-count metadata deterministic, semantically reverified the two false-positive dead letters without replacing B2 objects, and ages terminal failed-repair signature staging after three days. Five historical wallet days were verified at the latest sample, archive dead letters were zero and host free space was about 18.70 GB. Recent rollout-contaminated consumption still measured about 1.48 GB/day, so canonical retirement and any steady-state claim remain disabled until archive catch-up, compact/dual-read parity, a clean 24h slope and seven future days pass.",
...
"backup_policy": "Daily PostgreSQL16 custom-format dumps use zstd level 1 with no owner/ACL, SHA-256 sidecars and archive-list validation. One unacknowledged generation blocks the next; verified rotation retains a server recovery point and at least two off-host generations. Generation requires newest-size plus 2 GiB headroom and the interval is measured start-to-start. The 2026-08-25 2053352363-byte dump has its sidecar and off-site acknowledgement. Restores remain serial because parallel restore can race migration dependencies.",
...
"rollout_state": "Migrations through 051 are deployed. Archive writer/verifier/materializer, maintenance and operations monitor run R36 sha256:24bcc3fa77d...; wallet-alpha remains R34, ingestion R30, sampler R29 and Telegram R23. All 12 Walletscaner services were restart0/OOM-false and selected workers live=false at rollout verification. Server ledger revision 15 tracks storage-equilibrium-observation-r36; canonical retirement remains disabled and no score/risk gate was weakened."
},
"stack": {
"language": "typescript",
