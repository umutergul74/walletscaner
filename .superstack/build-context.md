...
"state": "r44-ingestion-operational-storage-observation-waiting",
"date": "2026-08-29",
"scope": "R44 adds a trade-only 15-second queue-age breaker over R43 discovery/ledger reliability; R42 materializer and B2 archive remain active and canonical wallet retirement remains disabled",
...
"verification": "R44 provider regression passed 51/51, typecheck/lint/build passed and the validation Linux image passed 416/416 with 48 intentional database-environment skips; database code is unchanged from R43's 33/33 PostgreSQL16 baseline. Production R44 drained startup backlog 236->51->0, all four discovery sources reached current/OK, and dead-letter/open-incident/unresolved-finality/signature backlog were zero. The natural stale-breaker event and clean 24h storage slope remain waiting.",
...
"rollout_state": "Migrations through 051 are deployed. Ingestion runs exact R44 sha256:44e6beae6b0e... and wallet-alpha remains exact R43 sha256:e87020e75036...; wallet-evidence materializer remains R42, archive writer/verifier/maintenance/monitor R36, sampler R29 and Telegram R23. R44 is restart/OOM-free and live=false. Server ledger revision 73 completed canary plus transfer-retirement verification; canonical wallet retirement remains disabled and no score/risk gate was weakened."
},
"stack": {
"language": "typescript",
