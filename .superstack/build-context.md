...
"maintenance_repair_local": "R48 is operational only for data-maintenance after partition-safe(tableoid,ctid) retention and independent bounded advisory inventory. Verified bounded pass retired22288completed signatures plus verifiedpayloads/swaps/superseded scores;100/100fresh prices survived; no canonical wallet evidence retired. Separate gap-repair-signature timeout and global storage equilibrium remain unresolved.",
"state": "r48-maintenance-r43-alpha-schema055-r51-capacity-rejected",
"date": "2026-08-31",
"fifo_populated_local": "054 CAS/realization/continuation plus exactCorder,1000-row pages,20000-row seed,suffix bounds and no-op checkpoint verification pass real11,857trade parity at3.15s/108.8MiB. 055 producer-independent statement triggers passed PG41/41 and populated upgrade2.089s/98984WAL/no4.9GBrewrite and are now deployed. R51 exactLinux46/46 and3.31s/108.58MiB passed, but production cycles76/40/72 useful moved queue39496->39803 with failures1->5; capacity acceptance failed and only alpha rolled back to exactR43. No canonical retirement.",
...
"scope": "R46 suppresses inadmissible price-enrichment revisions while retaining canonical writes. Migrations052-055 and producer-independent FIFO invalidation are deployed, but R51 queue-capacity acceptance failed and alpha is exactR43. B2 archive/R42 shadow active; canonical retirement disabled. Next alpha capacity design must resume first seeding across cycles and isolate historical seed from the live elevated lane.",
"migration": "Migrations through055 are deployed. Production052-055 checksums match source; wallet trade relfilenode60487 was unchanged, four noninternal triggers are enabled and zero indexes are invalid. The future decision-tape service remains disabled; schema deployment is not research promotion.",
"verification": "Paged FIFO source passed full nativePG16+zstd552/552,typecheck,lint,build, populated17GB restore/parity and exactLinux46/46 at108.58MiB. Production R51 resources/correctness passed but capacity failed: three cycles76/40/72 useful, queue39496->39803, failures1->5; exactR43 rollback verified. Do not call queue capacity operational or validated.",
"recovery_point": "memecoin_alpha_20260831T173517Z.dump;2804194002bytes;SHA112599cf58e915dd57993fa780b84cfc7e5c2fed22368d7e6b211fd80aa3e4ad;server SHA and two PG16 archive-list checks passed; older Aug29 offhost generation has matchingPG16.15 full local restore exit0,17GB/2603821wallettrades/zero invalidindexes",
...
"future-alpha-decisions",
"future-alpha-checkpoints",
"execution-quote-evidence",
"signal-outbox",
"paper-trades",
"risk-assessments"
],
...
"wallet_alpha_priority_queue": "Migrations 043/047/048/049 keep one revision-safe row and lanes; migration 056 adds an evidence-v1 expensive-work admission checkpoint shared by every producer. Canonical evidence always persists. An unseeded/unqualified wallet is deferred until 90-day evidence can upper-bound both eight profitability samples and eight distinct source-linked mature fixed-horizon samples; risk/quality/return/tail gates still run later. Deferred is an acknowledged queue revision, not deletion or permanent exclusion, and any producer event can transactionally promote it. Seeded/latest-qualified wallets always refresh. A bounded SKIP LOCKED reconciler handles legacy rows; the worker refuses a new claim without 15 seconds of cycle budget. On the restored 17.63GB/2.60M-trade clone, 7595/7603 pending rows deferred, eight retained ready, temp usage was unchanged, WAL was 46MiB and the database grew 0.63MiB; those eight then seeded/processed in 17.35s with zero pending/failures and 113.66MiB peak RSS. Production equilibrium remains a rollout gate.",
...
"future_alpha_decision_tape": "Migration 052 locally freezes survival-execution-tape-v1-20260830 with no historical import, at most 100 future exact-pool decisions per UTC day, six 0/15/30/60/120/300-second checkpoints, fixed $6/$25/$100 normalized Jupiter buy/sell quote evidence and 60-day terminal-only retention. Missing cluster/funder/bundle proof remains unknown, wrong/missing/stale/provider routes stay non-fill evidence, paper_eligible is database-constrained false and no provider response body is persisted. The isolated alpha-research worker is disabled by default, refuses a missing Jupiter key, uses two database connections, serial quote I/O, 0.03 CPU and 80 MiB. Populated PostgreSQL16 upgrade, exact constraints, leases/idempotency and capacity plans pass locally; migration/service are not deployed and do not establish profitable alpha.",
...
"rollout_state": "Migrations through055 are deployed. Ingestion runs R46 sha256:e376cfd6704c... and wallet-alpha exactR43 sha256:e87020e75036... after R51 capacity rollback; materializerR42, maintenanceR48, monitorR47b, samplerR29 and TelegramR23 remain. Alpha container7313793b5a18 is restart/OOM-free and live=false. R51 ledger revision9 records failed acceptance plus verified rollback; canonical retirement remains disabled and no score/risk gate was weakened."
},
"stack": {
"language": "typescript",
