...
"date": "2026-08-25",
"scope": "R29/R30 bounded alpha and finalized repair correctness; local R34 wallet-evidence archive plus compact-shadow storage lifecycle awaiting production rollout",
...
"storage_sustainability": "Raw chain-payload archive/retirement is operational. Migration 050 and the exact wallet-evidence daily artifact are implemented locally; migration 051 adds normalized profitability/followability/open-lot shadow facts with per-revision count and dual-digest parity. A full Aug24 clone gate archived/restored exactly 100078 records (174558627 source bytes to 16034890 zstd bytes) in 562489 ms at 4% CPU, then verified 218492 episodes, 251460 non-realized lots and 27498 mature outcomes in 260459 ms at 5% CPU. The shadow facts occupied about 188 MiB plus 3 MiB dimensions on the clone. Production rollout, real B2 wallet generations, seven-day shadow, compact-reader parity and cutover/retirement remain open; no canonical source row has been deleted.",
...
"rollout_state": "Migrations through 049 are deployed. Migrations 050/051 and tested image sha256:178566f79557... are local-only pending refreshed production preflight. Ingestion runs R30 sha256:afd180aed4fb... from 039f1c5; sampler/alpha/maintenance/operations run R29 sha256:ecfc19602057... from b3ab4c8. PostgreSQL/Redis, archive schedulers and bounded backup scheduler are active; paper-alert/API/web/legacy research remain stopped. ENABLE_LIVE_EXECUTION=false; no score/risk gate was weakened and no canonical wallet evidence was retired."
},
"stack": {
"language": "typescript",
