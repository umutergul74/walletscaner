...
"migration": "048_wallet_alpha_qualified_signal_lane.sql (additive; reclassifies pending legacy P2 without deleting evidence)",
"verification": "TypeScript, ESLint and workspace build pass; exact Node24/Linux/PostgreSQL16 image gate passed 88 files and 426 tests; live R29 maintenance/alpha and R30 ingestion canaries have zero current-cycle errors",
...
"quality_gates": "R30 passes TypeScript, ESLint, workspace production build and 426/426 tests across 88 files in the exact Node24/Linux image with disposable PostgreSQL16, zstd, deploy-time Python and the reviewed Compose contract. Production canaries do not replace future chronological shadow, exact-fill, independent 99% denominator or live-capital gates.",
...
"rollout_state": "Migrations through 048 are deployed. Ingestion runs R30 sha256:afd180aed4fb... from 039f1c5; sampler/alpha/maintenance/operations run R29 sha256:ecfc19602057... from b3ab4c8; Telegram remains compatible R23. PostgreSQL/Redis, archive schedulers and bounded backup scheduler are active; paper-alert/API/web/legacy research remain stopped. Host headroom is about 16 GB. Pump exact repair is reconciled; restart-created PumpSwap/CPMM intervals remain alpha-excluded while bounded repair converges. ENABLE_LIVE_EXECUTION=false; no score/risk gate was weakened."
},
"stack": {
"language": "typescript",
