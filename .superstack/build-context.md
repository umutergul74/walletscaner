...
"state": "r34-wallet-storage-shadow-operational-validation-waiting",
"date": "2026-08-26",
"scope": "R30 ingestion plus R34 wallet-evidence B2 archive, independent verification, compact shadow, bounded derived-cache rebuild and revisioned interruption-safe operations; canonical wallet retirement disabled",
...
"verification": "Full PostgreSQL16 clone archive/restore/materializer gate passed; R34 production canary passed one independently verified wallet day and compact parity with zero mismatch; guarded R35 one-shot reclaimed only reconstructible derived cache and restarted normal R34 alpha; storage equilibrium remains waiting for clean 24h plus seven future days",
...
"storage_sustainability": "Raw chain-payload archive/retirement is operational. Migration 050 wallet-evidence archive and migration 051 compact shadow now run as immutable R34: one production wallet day is independently B2-verified and compact-parity verified, nine historical days are pending and mismatch/dead-letter counts are zero. A guarded one-shot reclaimed about 1.51 GB of reconstructible legacy lot/episode cache without deleting canonical trades, entries or outcomes; 16442 observed wallets were revision-safely requeued. Host free space is about 18.6 GB. Canonical wallet retirement remains disabled; clean post-catch-up 24h equilibrium and seven future days are still mandatory.",
...
"rollout_state": "Migrations through 051 are deployed. Archive writer/verifier/materializer, operations monitor and wallet-alpha run R34 sha256:178566f79557...; ingestion runs R30 sha256:afd180aed4fb..., sampler/maintenance R29 sha256:ecfc19602057... and Telegram R23. All 12 Walletscaner services were restart0/OOM-false and selected workers live=false. Server ledger revision 9 tracks the 24h/7d storage shadow. Paper-alert/API/web/legacy research remain stopped; no score/risk gate was weakened and no canonical wallet evidence was retired."
},
"stack": {
"language": "typescript",
