...
"state": "r43-ingestion-alpha-operational-storage-observation-waiting",
"date": "2026-08-29",
"scope": "R43 bounded discovery reconnect/coalesced repair plus atomic wallet-scoped ledger replacement; R42 materializer and B2 archive remain active and canonical wallet retirement remains disabled",
...
"verification": "R43 targeted Linux tests pass 63/63, full Linux/zstd suite 418/418 and disposable PostgreSQL16 evidence integration 33/33. Production discovery stabilized at 13 healthy samples with zero transport/parser/finality error; the 294-attempt natural-key wallet completed with 7 episodes, 14 lots and zero duplicate natural keys. Storage equilibrium still waits for guarded 26-August partition retirement and a clean 24h slope.",
...
"storage_sustainability": "Raw chain-payload archive/retirement is operational. Wallet-evidence archive/materializer catch-up has completed its then-pending cohort, but canonical retirement and steady-state claims remain disabled until dual-read parity, a clean 24h slope and seven future days pass. The verified 26-August raw partition is 1270988800 bytes and remains hot until 2026-08-29 00:00 UTC; only the first normal guarded maintenance cycle may retire it. The exact R43 transfer artifact was removed after local SHA and loaded-image proof, leaving 17663750144 bytes free at the removal observation without touching canonical data, B2, volumes, BuildKit or rollback images.",
...
"rollout_state": "Migrations through 051 are deployed. Ingestion and wallet-alpha run exact R43 sha256:e87020e75036...; wallet-evidence materializer remains R42, archive writer/verifier/maintenance/monitor R36, sampler R29 and Telegram R23. Both R43 canaries are restart/OOM-free and live=false. Server ledger revision 64 completed transfer-retirement verification; canonical wallet retirement remains disabled and no score/risk gate was weakened."
},
"stack": {
"language": "typescript",
